...
local servers = { "jsonls", "sumneko_lua", "gopls", "marksman", "tsserver", "html", "sqls", "cssls", "tailwindcss",
  "quick_lint_js", "dockerls", "cssmodules_ls", "clangd" }
...
lspconfig["html"].setup {
  filetypes = { "gohtml", "html" }
}

for _, server in pairs(servers) do
  local opts = {
    on_attach = require("hbourgeot.lsp.handlers").on_attach,
    capabilities = require("hbourgeot.lsp.handlers").capabilities,
  }
